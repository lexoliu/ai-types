...
impl JsonRpcRequest {
    ...
    /// # Panics
    ///
    /// Panics if `params` cannot be serialized to JSON.
    #[must_use]
    pub fn with_params(
...
impl JsonRpcResponse {
    ...
    /// # Panics
    ///
    /// Panics if `result` cannot be serialized to JSON.
    #[must_use]
    ...
    /// # Errors
    ///
    /// Returns the JSON-RPC error when the response represents an error.
