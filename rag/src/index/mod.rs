...
pub trait VectorIndex: Send + Sync {
    ...
    ///
    /// # Errors
    /// Returns an error when the chunk embedding cannot be inserted.
    ...
    ///
    /// # Errors
    /// Returns an error when the query vector is incompatible with the index.
    ...
    ///
    /// # Errors
    /// Returns an error when stored entries are incompatible with the index.
