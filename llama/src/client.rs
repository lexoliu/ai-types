...
impl Llama {
    ...
    ///
    /// # Errors
    /// Returns an error when the llama backend or GGUF model cannot be initialized.
...
impl Builder {
    ...
    ///
    /// # Errors
    /// Returns an error when the backend cannot be initialized or the model file cannot be loaded.
